<template>
  <div class="container-fluid">
    <div class="mt-4 page-header min-height-300 border-radius-xl" :style="{
      backgroundImage:
        'url(src/assets/img/curved-images/curved14.jpg)',
    ...
    <div class="mx-4 overflow-hidden card card-body blur shadow-blur mt-n6">
      <div class="row gx-4">
        ...
        <div class="col-auto my-auto">
          <div class="h-100">
            <h5 class="mb-1">에어시그널</h5>
            <p class="mb-0 text-sm font-weight-bold">CEO / Co-Founder / 010-1234-5678</p>
          </div>
        </div>
  ...
  label: 'View Project',
    ...
    <div class="mt-4 row">
      <div class="col-12">
        <div class="mb-4 card">
          <div class="p-3 pb-0 card-header">
            <h6 class="mb-1">전체목록</h6>
            <p class="text-sm">Architects design houses</p>
          </div>
          <div class="p-3 card-body">
            <div class="row">
              <default-project-card title="SIA000123" :image="img1" label="Project #2" description="As Uber works through a huge amount of internal
                management turmoil." :authors="[
                  {
                    image: team1,
                    name: 'Elena Morison',
