<template>
  <div>
    <navbar :min-nav="navbarMinimize" :toggle="toggleConfigurator" :class="isNavFixed ? navbarFixed : ''" />
  </div>
  <div class="mx-3 mt-3 border-radius-xl position-relative" :style="{
    backgroundImage: 'url(src/assets/img/vr-bg.jpg)',
    backgroundSize: 'cover',
  }">
    <sidenav :custom_class="mcolor" :class="isTransparent" class="fixed-start" />
          ...
          <div class="pt-10 row">
            <div class="pt-5 text-center col-lg-1 col-md-1 pt-lg-0 ms-lg-5">
              ...
              <button class="p-2 mt-2 btn btn-white border-radius-lg d-block" type="button" data-bs-toggle="tooltip"
                data-bs-placement="left" title="Home">
