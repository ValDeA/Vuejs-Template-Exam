<template>
  <div class="py-4 container-fluid">
    <div class="row">
      <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
        <mini-statistics-card title="اموال اليوم" value="$53,000" :percentage="{
          value: '+55%',
          color: 'text-success',
        }" :icon="{
  ...
  background: iconBackground,
      ...
      <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
        <mini-statistics-card title="مستخدمو الیوم" value="2,300" :percentage="{
          value: '+3%',
          color: 'text-success',
        }" :icon="{
  ...
  background: iconBackground,
      ...
      <div class="col-lg-3 col-sm-6 mb-lg-0 mb-4">
        <mini-statistics-card title="عملاء جدد" value="+3,462" :percentage="{
          value: '-2%',
          color: 'text-danger',
        }" :icon="{
  ...
  background: iconBackground,
      ...
      <div class="col-lg-3 col-sm-6">
        <mini-statistics-card title="مبیعات" value="$103,430" :percentage="{
          value: '+5%',
          color: 'text-success',
        }" :icon="{
  ...
  background: iconBackground,
    ...
    <div class="mt-4 row">
      <div class="col-lg-5 mb-lg-0 mb-4">
        <div class="card">
          <div class="card-body p-3">
            <reports-bar-chart id="chart-bar" title="المستخدمين النشطين"
              description="(<strong>+23%</strong>)  من الأسبوع الماضي" :chart="{
                labels: [
                  'Apr',
                  'May',
                  'Jun',
  ...
  },
  {
    ...
    progress: { content: '43', percentage: 50 },
      ...
      <div class="col-lg-7">
        <gradient-line-chart id="chart-line" title="نظرة عامة على المبيعات" description="<i class='fa fa-arrow-up text-success'></i>
      <span class='font-weight-bold'>4% أكثر</span> في عام 2021" :chart="{
        labels: [
          'Apr',
          'May',
          'Jun',
    ...
    <div class="mt-4 row">
      ...
      <div class="col-lg-4 col-md-6">
        <timeline-list class="h-100" title="نظرة عامة على الطلبات" description="<i class='fa fa-arrow-up text-success' aria-hidden='true'></i>
        <span class='font-weight-bold'>24%</span> هذا الشهر">
          <timeline-item color="success" icon="bell-55" title=" $2400, تغييرات في التصميم" date-time="22 DEC 7:20 PM" />
          <TimelineItem color="danger" icon="html5" title="طلب جديد #1832412" date-time="21 DEC 11 PM" />
          <TimelineItem color="info" icon="cart" title="مدفوعات الخادم لشهر أبريل" date-time="21 DEC 9:34 PM" />
          <TimelineItem color="warning" icon="credit-card" title="تمت إضافة بطاقة جديدة للطلب #4395133"
            date-time="20 DEC 2:20 AM" />
          <TimelineItem color="primary" icon="key-25" title="فتح الحزم من أجل التطوير" date-time="18 DEC 4:54 AM" />
          <TimelineItem color="dark" icon="ni ni-money-coins" title="طلب جديد #9583120" date-time="15 DEC" />
        </timeline-list>
      </div>
    </div>
  </div>
